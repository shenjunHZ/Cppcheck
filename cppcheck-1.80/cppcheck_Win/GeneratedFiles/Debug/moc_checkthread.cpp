...
QT_MOC_LITERAL(3, 18, 11), // "fileChecked"
QT_MOC_LITERAL(4, 30, 4) // "file"

    },
    "CheckThread\0done\0\0fileChecked\0file"
};
...
void CheckThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->fileChecked((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (CheckThread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CheckThread::done)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (CheckThread::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CheckThread::fileChecked)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject CheckThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CheckThread.data,
      qt_meta_data_CheckThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 1
void CheckThread::fileChecked(const QString & _t1)
{
