/****************************************************************************
** Meta object code from reading C++ file 'translationhandler.h'
**
...
#include "../../../gui/translationhandler.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'translationhandler.h' doesn't include <QObject>."
...
const QMetaObject TranslationHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TranslationHandler.data,
      qt_meta_data_TranslationHandler,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TranslationHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TranslationHandler.stringdata0))
        return static_cast<void*>(const_cast< TranslationHandler*>(this));
