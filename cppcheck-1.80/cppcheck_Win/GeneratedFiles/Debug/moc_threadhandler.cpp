...
QT_MOC_LITERAL(4, 25, 10) // "threadDone"

    },
    "ThreadHandler\0done\0\0stop\0threadDone"
};
...
void ThreadHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ThreadHandler::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ThreadHandler::done)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ThreadHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ThreadHandler.data,
